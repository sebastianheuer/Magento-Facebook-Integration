...
/**
 * Provides an additional Action for Facebook single sign-on
 * @author: Sebastian Heuer <belanur@gmail.com>
 * @package Belanur_Facebook
 */
class Belanur_Facebook_Customer_AccountController extends Mage_Customer_AccountController
{
    /**
    ...
    public function loginWithFacebookAction()
    {
        ...
        /** @var $customer Belanur_Facebook_Model_Customer_Customer */
        ...
        if ($customer->getId() && $this->_isValidFacebookSession($facebookId)) {
            ...
            try {
                ...
                $customer->save();
                $this->_getSession()->addNotice(Mage::helper('customer')->__('Since this is your first login,
                    we have created a new account for you. Enjoy!'));
                $this->_getSession()->setCustomerAsLoggedIn($customer);
            } catch (Exception $e) {
